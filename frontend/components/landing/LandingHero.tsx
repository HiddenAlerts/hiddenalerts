...
export function LandingHero() {
  return (
    <section
      id="top"
      className="relative scroll-mt-16 overflow-hidden px-4 py-10 md:px-6 md:py-14 lg:py-16"
    >
      <div
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-2 lg:gap-10">
        <div className="flex flex-col">
          ...
          <h1 className="font-heading text-foreground mt-3 text-4xl leading-[1.08] font-bold tracking-tight text-balance sm:text-5xl lg:text-[3.15rem]">
            {HERO_CONTENT.titleLead}{' '}
            <span className="text-primary-500">{HERO_CONTENT.titleEmphasis}</span>
          </h1>

          <p className="text-body mt-4 max-w-xl text-base leading-relaxed sm:text-lg">
